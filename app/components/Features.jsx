        ...
        <div className="max-w-screen-xl mx-auto flex">
            <div className="flex-1">
                <div className="relative h-full w-full">
                    ...
                    <motion.img 
                    variants={{onScreen:{opacity:1, translateY:0, transformOrigin:"top",}, offScreen:{opacity:0, translateY:-40,}}} 
                    initial="offScreen" whileInView="onScreen" 
                    viewport={{once:true}} 
                    transition={{duration:1.5, type:"spring",}}
                    src={FeaturesImage.src} alt="" className="left-40 w-[60%] absolute top-20" />
                </div>
            </div>
            <div className=" flex-1 py-32 flex flex-col gap-8 ">
                ...
                viewport={{once:true}} 
                transition={{duration:1.5, type:"spring",}}
                className="text-[#bfbfbf] flex flex-col gap-3 pr-8">
