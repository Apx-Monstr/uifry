        ...
        <div className="max-w-screen-xl mx-auto flex">
            <div className="flex-1">
                <div className="relative h-full w-full">
                    ...
                    <img src={BlackRings.src} alt="" className="absolute -top-4 -left-10" />
                    <img src={FeaturesImage.src} alt="" className="left-40 w-[60%] absolute top-20" />
                </div>
            </div>
            <div className=" flex-1 py-32 flex flex-col gap-8 ">
                <div className='text-lg text-[#FF5555] clash-medium'>
                    F E A T U R E S
                    <h1 className='text-5xl clash-bold text-black'>
                        Uifry Premium
                    </h1>
                </div>
                <div className="text-[#bfbfbf] flex flex-col gap-3 pr-8">
                    <div className="flex gap-2 clash-bold text-lg text-black items-center">
