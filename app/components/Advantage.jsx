            ...
            <div className="flex">
                <div className="flex-1 py-36 flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-6 pr-8">
                        <div className="flex items-center gap-4 clash-medium text-2xl">
                ...
                <div className="flex-1">
                    <div className="relative h-full w-full">
                        ...
                        <img src={Advantage1.src} alt="" className="left-40 w-[60%] absolute top-20" />
                    </div>
                </div>
            </div>
            <div className="flex">
                <div className="flex-1">
                    <div className="relative h-full w-full">
                        <img src={Gradient.src} alt="" className="absolute top-0 -left-10" />
                        <img src={BlackRings.src} alt="" className="absolute -top-4 -left-10" />
                        <img src={Advantage2.src} alt="" className="left-40 w-[60%] absolute top-20" />
                    </div>
                </div>
